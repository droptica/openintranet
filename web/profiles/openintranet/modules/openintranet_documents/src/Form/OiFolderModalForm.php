...
/**
 * Modal form controller for the OI Folder entity.
 */
final class OiFolderModalForm extends OiFolderForm {
  ...
  public function ajaxSubmit(array &$form, FormStateInterface $form_state): AjaxResponse {
    ...
    $entity = $this->entity;
    $response->addCommand(new MessageCommand(
      $this->t('Folder %label has been saved.', ['%label' => $entity->getName()]),
      NULL,
      ['type' => 'status'],
    ));
    ...
    if ($parent instanceof OiFolderInterface) {
      $url = Url::fromRoute('openintranet_documents.folder.view', ['oi_folder' => $parent->id()])->toString();
    }
    else {
