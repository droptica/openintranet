...
#[ContentEntityType(
  ...
  links: [
    'collection' => '/admin/people/oi-groups',
    'add-form' => '/admin/people/oi-groups/add',
    'canonical' => '/admin/people/oi-groups/{oi_group}',
    'edit-form' => '/admin/people/oi-groups/{oi_group}/edit',
    'delete-form' => '/admin/people/oi-groups/{oi_group}/delete',
    'delete-multiple-form' => '/admin/people/oi-groups/delete-multiple',
  ],
