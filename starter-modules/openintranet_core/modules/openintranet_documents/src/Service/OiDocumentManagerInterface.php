...
interface OiDocumentManagerInterface {
  ...
  /**
   * Gets content that references a document.
   *
   * Automatically discovers all entity_reference fields targeting oi_document
   * and queries for nodes that reference the given document.
   *
   * @param int $documentId
   *   The document entity ID.
   *
   * @return \Drupal\node\NodeInterface[]
   *   Array of nodes referencing the document.
   */
