...
namespace Drupal\openintranet_core;
...
class BookStructureImporter {
  ...
  public function import(?string $file = NULL): array {
    ...
    if ($file === NULL) {
      // The structure ships with the site template (recipes/openintranet) or,
      // in the legacy distribution, with the default_content recipe.
      $candidates = [
        $this->appRoot . '/../recipes/openintranet/book/book.structure.yml',
        $this->appRoot . '/../recipes/default_content/book/book.structure.yml',
      ];
